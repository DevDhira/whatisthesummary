...
export default function BlogSummarizer() {
  ...
  const submitUrl = async () => {
    ...
    await axios.post('http://127.0.0.1:8000/api/blog_summarize/', data)
      .then(response => {
  ...
  return (
    <div className='h-screen relative w-full p-10 items-start' >




      <div >
        <h1 className='w-full text-center my-5 text-2xl font-bold' > Blog Summarizer </h1>
